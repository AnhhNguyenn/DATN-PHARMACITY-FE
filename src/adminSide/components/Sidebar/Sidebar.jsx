            ...
            <List>
              ...
              >
                <ListItemButton sx={{ pl: collapsed ? "1rem" : "2rem" }}>
                  ...
                  {!collapsed && (orderMenuOpen ? <ExpandLess /> : <ExpandMore />)}
                </ListItemButton>
              </ListItem>

              {/* Submenu Danh sách order */}
              <Collapse in={orderMenuOpen && !collapsed} timeout="auto" unmountOnExit>
              ...
              >
                <ListItemButton sx={{ pl: collapsed ? "1rem" : "2rem" }}>
                  ...
                  {!collapsed && (exportMenuOpen ? <ExpandLess /> : <ExpandMore />)}
                </ListItemButton>
              </ListItem>

              {/* Submenu Nhập/Xuất */}
              <Collapse in={exportMenuOpen && !collapsed} timeout="auto" unmountOnExit>
                <List component="div" disablePadding sx={{ color: "white" }}>
