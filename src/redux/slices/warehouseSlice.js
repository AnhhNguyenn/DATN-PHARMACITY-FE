...
import { getAllWarehouseServices, editWarehouseService, addWarehouseService } from "../../services/categoryServices";
...
export const editWarehousetApi = (formData, navigate) => {
    return async (dispatch) => {
        try {
